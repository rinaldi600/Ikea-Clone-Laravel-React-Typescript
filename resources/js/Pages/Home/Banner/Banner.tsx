    ...
    return (
        <>
            <div onMouseEnter={() => setSlickPrev(true)} onMouseLeave={() => setSlickPrev(false)} className="h-[369.013px] cursor-pointer relative bg-red-400 w-[100%] xl:w-[95%]">
                <img className='w-full h-full object-center object-cover' src={BannerImageOne} alt="Banner One" />
                <div className='flex bg-transparent justify-between items-center absolute inset-0 w-full h-full'>

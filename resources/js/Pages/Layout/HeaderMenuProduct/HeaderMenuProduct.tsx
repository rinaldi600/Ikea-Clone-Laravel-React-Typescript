...
function HeaderMenuProduct(props: PropsInterface) {
    ...
    return (
        <>
                ...
                <div className="flex justify-between lg:justify-normal mx-auto w-[90%] gap-2 min-h-fit">
                    <div className="flex items-center gap-5">
                        <div
                            onClick={() => {
                                setToggle(true);
                                props.setValueFixedNavbar(true);
                            }}
                            className="w-[40px] hidden lg:flex items-center justify-center cursor-pointer h-[40px] hover:bg-[#F5F5F5] rounded-full"
                        >
                            <svg
                                ...
                                strokeWidth="1.5"
                                stroke="currentColor"
                                className="w-[24px] text-[#111111] h-[24px]"
                            >
                                <path
                                    strokeLinecap="round"
                    ...
                    <div className="w-full hidden lg:flex items-center relative">
                        <SearchProduct
                            setValueSearchProduct={setValueSearchProduct}
                        />
                    </div>
                    <div className="flex flex-wrap justify-center lg:justify-normal lg:flex-nowrap items-center lg:gap-2">
                        <div
                            onClick={() => setValueSearchProduct(true)}
                            className="w-[40px] flex lg:hidden items-center justify-center cursor-pointer h-[40px] hover:bg-[#F5F5F5] rounded-full"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                ...
                                strokeWidth="1.5"
                                stroke="currentColor"
                                className="w-6 h-6 text-center mx-auto font-bold"
                            >
                                <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
            ...
            <div
                className={`w-full ${
                    valueToggleSearchProduct ? "lg:hidden" : "hidden"
            ...
            {valueToggle && (
                <SidebarHeader
                    setValueFixedNavbar={props.setValueFixedNavbar}
                    valueToggle={setToggle}
                />
            )}
        </>
    );

...
function SearchProduct(props : PropsInterface) {
    ...
    return (
        <div className="w-full absolute z-30 inset-0 min-h-[400px] bg-red-300 p-2 rounded-lg">
            <div className={`max-w-[1000px] flex items-center mx-auto h-[60px] overflow-hidden bg-[#F5F5F5] rounded-full ${toggleBorder ? 'border-2 border-[#0058A3]' : ''}`}>
                ...
                <div className="w-[89%] md:w-[92%] lg:w-[95%]">
                    <input onFocus={() => setBorderToggle(true)} onBlur={() => setBorderToggle(false)} type="text" placeholder="Cari..." className="w-full h-full border-none outline-none bg-[#F5F5F5] border-transparent focus:border-transparent focus:ring-0" />
                </div>
                <div className="pr-5 cursor-pointer lg:hidden">
